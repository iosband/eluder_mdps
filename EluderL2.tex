...
To do this we will use the eluder dimension build confidence sets for the reward and transition which contain the true functions with high probability.
We will then bound the regret of our algorithm by the maximum deviation within the confidence sets.
...
%---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
\section{Analysis}
We will now show that the expected regret can be decomposed in terms of the expected Bellman error, which will allow us to apply the general confidence set results from Section \ref{sec: conf}.
